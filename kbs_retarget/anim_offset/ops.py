...
class ANIMRETARGET_OT_modal_test(Operator):
    """Slider Operators Preset"""
    bl_idname = "anim.retarget_aide_modal_test"
    bl_label = "Test"
...
class ANIMRETARGET_OT_activate_anim_offset(Operator):
    """Activates Anim Offset without maks"""

    bl_idname = "anim.retarget_aide_activate_anim_offset"
    bl_label = "AnimOffset"
...
class ANIMRETARGET_OT_deactivate_anim_offset(Operator):
    """Deactivates Anim Offset"""

    bl_idname = "anim.retarget_aide_deactivate_anim_offset"
...
class ANIMRETARGET_OT_add_anim_offset_mask(Operator):
    """Adds or modifies Anim Offset mask and activates it"""

    bl_idname = "anim.retarget_aide_add_anim_offset_mask"
    ...
    def finish_mask(self, context):
        ...
        context.scene.animretarget.anim_offset.mask_in_use = True
        context.area.tag_redraw()
...
class ANIMRETARGET_OT_delete_anim_offset_mask(Operator):
    """Deletes Anim Offset mask and deactivates it"""

    bl_idname = "anim.retarget_aide_delete_anim_offset_mask"
...
class ANIMRETARGET_OT_anim_offset_settings(Operator):
    """Shows global options for Anim Offset"""

    bl_idname = "anim.retarget_aide_anim_offset_settings"
    ...
    def draw(self, context):
        ...
        # layout.prop(anim.retarget_aide_anim_offset, 'use_markers', text='Use Markers')


classes = (
    # ANIMRETARGET_OT_modal_test,
    ANIMRETARGET_OT_add_anim_offset_mask,
    ANIMRETARGET_OT_activate_anim_offset,
    ANIMRETARGET_OT_deactivate_anim_offset,
    ANIMRETARGET_OT_delete_anim_offset_mask,
    ANIMRETARGET_OT_anim_offset_settings,
)
