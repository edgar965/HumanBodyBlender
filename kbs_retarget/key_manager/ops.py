...
class AAT_OT_move_key(Operator):
    ...
    bl_idname = 'anim.retarget_aide_move_key'
    bl_label = "Move Key"
...
class AAT_OT_insert_frames(Operator):
    ...
    bl_idname = 'anim.retarget_aide_insert_frames'
...
class AAT_OT_set_key_type(Operator):
    ...
    bl_idname = 'anim.retarget_aide_set_key_type'
...
class AAT_OT_delete_key_type(Operator):
    ...
    bl_idname = 'anim.retarget_aide_delete_key_type'
...
class AAT_OT_select_key_type(Operator):
    ...
    bl_idname = 'anim.retarget_aide_select_key_type'
...
class AAT_OT_set_handles_type(Operator):
    ...
    bl_idname = 'anim.retarget_aide_set_handles_type'
...
class AAT_OT_select_key_parts(Operator):
    ...
    bl_idname = 'anim.retarget_aide_select_key_parts'
...
class AAT_OT_set_handles_interp(Operator):
    ...
    bl_idname = 'anim.retarget_aide_set_handles_interp'
...
class ANIMRETARGET_OT_key_manager_settings(Operator):
    """Shows global options for Curve Tools"""

    bl_idname = "anim.retarget_aide_key_manager_settings"
