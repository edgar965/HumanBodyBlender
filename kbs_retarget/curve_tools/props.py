...
class AnimRetargetClone(PropertyGroup):
...
class AnimRetargetFrameBookmark(PropertyGroup):
    frame: IntProperty()
    name: StringProperty()


class AnimRetargetTool(PropertyGroup):
    ...
    frame_bookmarks: CollectionProperty(type=AnimRetargetFrameBookmark)
